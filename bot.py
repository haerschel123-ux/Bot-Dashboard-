...
# Dashboard-Event-Puffer (reines stdlib-Modul, keine Drittpakete) – für die
# Live-Karte/Event-Liste. Der Web-Server selbst wird erst in setup_hook geladen.
from dashboard import events as dashboard_events
...
class DayZBot(discord.Client):
    ...
    async def _dispatch(self, ev: Dict):
        ...
        try:
            dashboard_events.record(ev, self.parser.player_positions)
        except Exception:
            pass
